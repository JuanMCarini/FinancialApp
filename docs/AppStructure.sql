...
CREATE TABLE customers (
    ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    CUIL BIGINT NOT NULL, DNI BIGINT NOT NULL,
    Last_Name VARCHAR(100) NOT NULL,
    Name VARCHAR(100) NOT NULL,
    Gender ENUM('M', 'F', 'NB', 'T', 'G', 'A', 'O') DEFAULT 'O',
    Date_Birth DATETIME, Age_at_Discharge TINYINT,
    ID_Province INT,
    FOREIGN KEY (ID_Province) REFERENCES provinces(ID) ON DELETE SET NULL ON UPDATE CASCADE,
    Locality VARCHAR(100),
    Street VARCHAR(100),
    Nro INT, CP INT, Feature INT, Telephone VARCHAR(25),
...
CREATE TABLE collection (
    ...
    Type_Collection ENUM('COMÚN','ANTICIPADA', 'PARCIAL', 'REDONDEO', 'PENALTY', 'CAN. ANT.', 'BON. CAN. ANT.', 'REVERSA'),
    Capital DECIMAL(15,2) NOT NULL,
    Interest DECIMAL(15,2) NOT NULL,
    IVA DECIMAL(15,2) NOT NULL,
    Total DECIMAL(15,2) NOT NULL);
